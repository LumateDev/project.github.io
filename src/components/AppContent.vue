<template>
			...
			<div class="blog-guts col-12 col-md-4">
				<div class="blog-body position-relative">
					<article>
						<a href="#">
							<div class="blogimage">
								<img src="@/assets/img/image1.png" class="img-fluid" alt="1" />
							</div>
					...
					<a href="#">
						<div class="blog-body position-relative">
							<div class="blogimage-internalized imagemain">
								<img src="@/assets/img/image2.png" class="img-fluid" alt="2" />
							</div>
							<div class="header-date header-date-internalized px-3 py-4">
								<h5>
									<b> Использование отчетов Ecommerce в Яндекс.Метрикеа</b>
								</h5>
							</div>
						</div>
					</a>
					...
					<a href="#">
						<div class="cringe position-relative">
							<div class="blogimage-internalized">
								<img src="@/assets/img/image3.png" class="img-fluid" alt="3" />
							</div>
							<div class="header-date header-date-internalized px-3 py-4">
								<h5>
									<b>
										Повышение конверсии страницы с формой заявки с применением
										AB-тестирования Повышение конверсии страницы с формой заявки
										с применением AB-тестирования</b
									>
								</h5>
								<div class="blog-date">
									<p>24.01.2020</p>
			...
			<div class="blog-guts col-12 col-md-4">
				<article>
					<a href="#">
						<div class="cringe position-relative">
							<div class="blogimage-internalized">
								<img src="@/assets/img/image4.png" class="img-fluid" alt="4" />
							</div>
							<div class="header-date header-date-internalized px-3 py-4">
								<h5>
									<b>
				...
				<article>
					<a href="#">
						<div class="position-relative">
							<div class="blogimage">
								<img src="@/assets/img/image5.png" class="img-fluid" alt="5" />
							</div>
							<div class="header-date px-3 py-4">
								<h5>
									Обмен товарами и заказами интернет-магазинов на Drupal 7 с 1С:
	...
	<div class="Feedback">
		<h1 class="faq-label text-center mb-5">Отзывы</h1>
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="FeedbackBloc">
						<img src="@/assets/img/logo_0.png" class="img-fluid" alt="1" />
						<h6>
							Долгие поиски единственного и неповторимого мастера на
							многострадальный сайт www.cielparfum.com, который был собран
							крайне некомпетентным программистом и раз в месяц стабильно грозил
							погибнуть, привели меня на сайт и, в итоге, к ребятам из
							Drupal-coder. И вот уже практически полгода как не проходит и дня,
							чтобы я не поудивлялась и не порадовалась своему везению!
						</h6>

						С уважением, Наталья Сушкова руководитель Отдела веб-проектов Группы
						компаний «Си Эль парфюм»
					</div>
				</div>
				<div class="col">
					<div class="FeedbackBloc">
						<img src="@/assets/img/logo_2.png" class="img-fluid" alt="2" />
						<h6>
							Долгие поиски единственного и неповторимого мастера на
							многострадальный сайт www.cielparfum.com, который был собран
							крайне некомпетентным программистом и раз в месяц стабильно грозил
				...
				<div class="col">
					<div class="FeedbackBloc">
						<img src="@/assets/img/logo_2.png" class="img-fluid" alt="3" />
						<h6>
							Долгие поиски единственного и неповторимого мастера на
							многострадальный сайт www.cielparfum.com, который был собран
							крайне некомпетентным программистом и раз в месяц стабильно грозил
							погибнуть, привели меня на сайт и, в итоге, к ребятам из
							Drupal-coder. И вот уже практически полгода как не проходит и дня,
							чтобы я не поудивлялась и не порадовалась своему везению! Починили
							все, что не работало - от поиска до отображения меню.
						</h6>
				...
				<div class="col">
					<div class="FeedbackBloc">
						<img src="@/assets/img/logo_0.png" class="img-fluid" alt="4" />
						<h6>
							Долгие поиски единственного и неповторимого мастера на
							многострадальный сайт www.cielparfum.com, который был собран
							крайне некомпетентным программистом и раз в месяц стабильно грозил
				...
				<div class="col">
					<div class="FeedbackBloc">
						<img src="@/assets/img/logo-estee.png" class="img-fluid" alt="5" />
						<h6>
							Долгие поиски единственного и неповторимого мастера на
							многострадальный сайт www.cielparfum.com, который был собран
							крайне некомпетентным программистом и раз в месяц стабильно грозил
							погибнуть, привели меня на
						</h6>
				...
				<div class="col">
					<div class="FeedbackBloc">
						<img src="@/assets/img/logo.png" class="img-fluid" alt="7" />
						<h6>
							Долгие поиски единственного и неповторимого мастера на
							многострадальный сайт www.cielparfum.com, который был собран
							крайне некомпетентным программистом и раз в месяц стабильно грозил
